    ...
    return (
        <div className=" p-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 justify-items-center mt-0 gap-5">
                <div className="w-full max-w-lg mx-auto shadow-2xl rounded-2xl bg-base-100 order-2 md:order-1" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="2000">
                ...
                <div className="max-w-full order-1" data-aos="fade-up" data-aos-easing="linear" data-aos-duration="2000">
