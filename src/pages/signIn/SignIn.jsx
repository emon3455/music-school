            ...
            <div className="grid grid-cols-1 md:grid-cols-2 justify-items-center items-center gap-5 p-2">
                <div className="card w-full max-w-sm drop-shadow-2xl bg-base-100 order-2 md:order-1">
                    <form onSubmit={handleSubmit(onSubmit)} className="card-body">
                        <h2 className="text-3xl font-bold text-center text-violet-700">Login</h2>
                        ...
                        <input type="submit" value="Login" className="btn btn-info mt-2"  />

                    </form>
                    <div className="px-4 pb-2">
                        <p className="text-center text-gray-600">
                            Don't have an Account? <Link className="text-sky-600" to="/signup">Create an account</Link>
                        </p>
