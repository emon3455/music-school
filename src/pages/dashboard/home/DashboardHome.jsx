...
const DashboardHome = () => {
    ...
    return (
        <div>
            ...
            <h2 className="text-4xl font-extrabold text-center my-10 ">  <FaMusic className="inline-block text-orange-400"></FaMusic>  Welcome To <span className="text-violet-600">Music</span>  Scholling BD  <FaMusic className="inline-block text-green-500"></FaMusic></h2>
